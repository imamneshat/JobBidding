    ...
    <body>
        ...
        <?php include('header/header1.php');
            ...
            if(isset($_GET['uid']) && !empty($_GET['uid'])){
                ...
                $sqld ="DELETE FROM `user` WHERE `u_id`='$url'";
                $result1 = mysqli_query($conn,$sqld);
        ?>
        <div class="container" id="container">
            <div class="row">
                <div class="col-md-12">
                    <center><h2><u><b>User Data</b></u></h2></center>
                    <table class="table table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $rows['u_dob'];?></td>
                                <td><?php echo $rows['u_sex'];?></td>
                                <td><?php echo $rows['u_address'];?></td>
                                <td><button class="btn btn-info btn-lg"><a href="user_data.php?uid=<?php echo $uid;?>">Delete</a></button></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
