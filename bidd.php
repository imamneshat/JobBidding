						    ...
						    <tbody>
						    	<?php 
						    		include('connection.php');
                                        ...
                                        $sql ="SELECT job_detail.job_title,
                                        job_detail.job_detail_id,
                                        job_detail.job_budget,bidding.u_id,
                                        ...
                                        bidding 
                                        ON 
                                        job_detail.job_detail_id = bidding.job_detail_id AND bidding.u_id = $uid";
						        ...
						        <tr>
						        	<?php echo"
                                        <td>
                                            <a href=\"detailbid.php?job_detail_id=$jobbid-$job_title\">{$rows['job_title']}
                                            </a>
                                        </td> "
                                    ?>   
